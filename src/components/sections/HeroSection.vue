    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32 w-full z-10">
      <div class="grid lg:grid-cols-2 gap-10 items-center">
        <div class="space-y-6">
          ...
          <p id="mission" class="scroll-mt-28 hero-text text-lg sm:text-xl lg:text-2xl leading-relaxed text-white/90 drop-shadow">
          ...
          <div class="hero-buttons flex flex-wrap gap-4">
            ...
            <BaseButton href="#approach" variant="secondary" class="transform hover:scale-110 transition-all duration-300">
              How We Work
            </BaseButton>
          </div>
