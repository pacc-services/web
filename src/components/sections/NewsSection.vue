<template>
  <section id="news" class="relative overflow-hidden bg-gradient-to-br from-slate-50 to-white py-16 px-6">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-12" data-scroll-animate>
        ...
        <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 mb-6 leading-tight tracking-tight">
          News &
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-green">Announcements</span>
        </h2>
      ...
      <div class="relative" data-scroll-animate>
        ...
        <div ref="embla" class="overflow-hidden px-4 sm:px-6 lg:px-10 py-2">
          <div class="flex">
            <!-- Article Cards -->
            <article v-for="article in recentArticles" :key="article.slug"
              ...
              <div
                ...
                <div v-if="article.image"
                  class="bg-gradient-to-br from-brand/5 to-brand-green/5 p-8 flex items-center justify-center">
              ...
              <router-link to="/news"
                ...
                <div
                  ...
                  <div class="text-center">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      class="h-12 w-12 mx-auto mb-2 text-white transition-transform group-hover:scale-110" fill="none"
        ...
        <div v-if="carouselItems.length > 1" class="flex items-center justify-center gap-4 mt-6">
          ...
          <div class="flex gap-2">
            <button v-for="(_item, index) in carouselItems" :key="index" @click="scrollTo(index)" class="transition-all"
